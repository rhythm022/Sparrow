...
describe('area', () => {
  ...
  test('radar with background', () => {
    plot({
      ...
      tagName: 'path',
      d: 'M 459.99999999999994 200 L 300 380 L 280 200 L 299.99999999999994 39.99999999999999 L 459.99999999999994 200 L 320 200 L 300 180 L 280 200 L 300 220.00000000000003 L 320 200 Z',
      fill: '#5B8FF9',
    });
  });
